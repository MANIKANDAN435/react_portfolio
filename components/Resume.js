...
import MYRESUMEPDF from '../My_Resume/My_Resume.pdf'
const Resume = () => {
        ...
        return (
            <section className='  md:h-auto flex flex-col items-center  md:flex md:flex-row  bg-linked h-full' id='Resume'>
                ...
                <div className=' md:w-1/2 md:px-5 md:flex md:flex-col md:justify-center md:items-start text-center md:mb-5  mb-3 font-bold'>
                    ...
                    <p className='md:text-2xl text-sm '>You can view my resume <a href={MYRESUMEPDF} download className='bg-darkblue md:px-5 md:py-1  sm:text-sm py-1 px-1 md:text-lg md:w-1/3 hover:border-2 border-pureblack'>Download</a></p> 
                </div>
            </section>
        )
}
